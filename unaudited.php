...
<head>
    ...
    <title>Unaudited-AFS Financial Statements</title>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-5">
                        <h1 class="display-6 large ff-heading text-white position-relative ps-4">
                            ...
                            <span>Unaudited-AFS Financial Statements</span>
                        </h1>
                    </div>
                    <div class="col-lg-7">
                        <div class="position-relative">
                            ...
                            <img src="assets/images/common/History-of-Burdwan-Municipality.jpg" width="746" height="250"
                                alt="Unaudited-AFS Financial Statements"
        ...
        <section class="py-5 cms__content__wrapper">
            <div class="container py-md-5">
                <div class="overflow-auto">
                    <table class="table table-striped border" style="min-width: 700px;">
                        <thead>
                            <tr>
                                <th>Sl No</th>
                        ...
                        <tbody>
                            <?php
                                $counter=1;
                                $selectFinancialStatement = mysqli_query($conn,"select * from ".$financialStatementDetailsTbl." where title='Unaudited AFS' and status='1' order by financial_year desc");
