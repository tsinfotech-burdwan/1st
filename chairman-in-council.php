...
<head>
    ...
    <title>Chairman in Council</title>
                    ...
                    <div class="col-lg-7">
                        <div class="position-relative">
                            ...
                            <img src="assets/images/common/History-of-Burdwan-Municipality.jpg" width="746" height="250"
                                alt="Chairman in Council" class="img-fluid subpage__thumbnail w-100 object-fit-cover "
            ...
            <div class="container py-md-5">
                <div class="overflow-auto">
                    <table class="table table-striped border" style="min-width: 400px;">
                        ...
                        <tbody>
                        <?php 
                            $selectChairmanInCouncil=mysqli_query($conn,"select * from ".$chairmanInCouncilDetailsTbl." where status='1' AND designation NOT IN ('Councillor')");
