...
<head>
    ...
    <title>Demand & Collection Statements</title>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-5">
                        <h1 class="display-6 large ff-heading text-white position-relative ps-4">
                            ...
                            <span>Demand & Collection Statements</span>
                        </h1>
                    </div>
                    <div class="col-lg-7">
                        <div class="position-relative">
                            ...
                            <img src="assets/images/common/History-of-Burdwan-Municipality.jpg" width="746" height="250"
                                alt="Demand & Collection Statements"
                ...
                <div class="overflow-auto">
                    <table class="table table-striped border" style="min-width: 800px;">
                        ...
                        <tbody>
                            <?php
                                $counter=1;
                                $selectFinancialStatement = mysqli_query($conn,"select * from ".$financialStatementDetailsTbl." where title='Demand And Collection' and status='1' order by financial_year desc");
