<?php 
	...
	{ 
		...
		{		
			...
			$selectUserDetails = mysqli_query($conn,"select * from ".$masterUserDetailsTbl." where user_id='".$function->dataDecryption($_GET['valueId'])."'");
			$rowUserDetails = mysqli_fetch_array($selectUserDetails);
?> 
<!DOCTYPE html>
	...
	<head>
		...
		<script> 
			...
			function addNewUserDetails() 
			{
				...
				{
					var datastring="fullNameUser="+fullNameUser+"&contactUser="+contactUser+"&addressUser="+addressUser+"&departmentUser="+departmentUser+"&designationUser="+designationUser+"&role=updateUserDetails&valueId="+valueId; 
					$.ajax({
						url: "backendFilesFolders/masterUserBackend",
						type:"post",
						catch:false,
						...
						success: function(result)
						{
							...
							{
								alert("Employee Updated But Error In Login !!!");
								document.getElementById("addUserButton").style.display = "block";
								document.getElementById("loadingAddUserButton").style.display = "none";
								location.reload();
							}
												...
												<div class="form-body">
													<div class="row">
															...
															<div class="form-group row">
																...
																<div class="col-md-8">
																	<div class="position-relative has-icon-left">
																		<input type="hidden" id="valueId" name="valueId" value="<?php echo $_GET['valueId'];?>">
																		<input type="text" id="fullNameUser" name="fullNameUser" placeholder="Full Name" class="form-control" value="<?php echo $rowUserDetails['user_full_name'];?>" onchange="chkUserFullName();" required>
														...
														<div class="col-6">
															<div class="form-group row">
																...
																<div class="col-md-8">
																	<div class="position-relative has-icon-left">
																		<input type="number" id="contactUser" name="contactUser" placeholder="Mobile" class="form-control" value="<?php echo $rowUserDetails['user_contact'];?>" onchange="chkContactNumber();" required>
																		<div class="form-control-position">
														...
														<div class="col-6">
															<div class="form-group row">
																...
																<div class="col-md-8">
																	<div class="position-relative has-icon-left">
																		<textarea id="addressUser" name="addressUser" placeholder="Address" class="form-control" onchange="chkUserAddress();"><?php echo $rowUserDetails['user_address'];?></textarea>
																		<div class="form-control-position">
													...
													<div class="row">
																...
																<div class="col-md-8">
																	<div class="position-relative has-icon-left">
																		...
																		<?php
																			...
																			{
																		?>
																			<option value="<?php echo $rowDepartment['department_id'];?>" <?php if($rowDepartment['department_id']==$rowUserDetails['department_id']){echo "selected";}?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rowDepartment['department_name'] ?></option>
																		<?php
																			}
																		?>
																		</select>
															...
															<div class="form-group row">
																...
																<div class="col-md-8">
																	<div class="position-relative has-icon-left">
																		...
																		<?php
																			$queryDesignation = mysqli_query($conn,"select * from ".$masterDesignationTbl." where department_id='".$rowUserDetails['department_id']."'");
																			while ($rowDesignation = mysqli_fetch_array($queryDesignation)) 
																			{
																		?>
																			<option value="<?php echo $rowDesignation['designation_id'];?>" <?php if($rowDesignation['designation_id']==$rowUserDetails['designation_id']){echo "selected";}?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rowDesignation['designation_name'] ?></option>
																		<?php
																			}
																		?>
																		</select>
														...
														<div class="col-md-8 offset-md-4">
															<button type="button" onclick="addNewUserDetails();" id="addUserButton" class="btn btn-primary mr-1 mb-1">Update User</button>
