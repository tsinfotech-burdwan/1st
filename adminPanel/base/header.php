                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav bookmark-icons">
                            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="dashboard" data-toggle="tooltip" data-placement="top" title="Todo"><i class="ficon feather icon-check-square"></i></a></li>
                        ...
                        <li class="dropdown dropdown-user nav-item">
							<a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none">
									<span class="user-name text-bold-600"><?php echo $_SESSION[$counterSessionName]['user_full_name']; ?></span>
									<span class="user-status">Online</span>
								</div>
								<?php  
									$selectUserProfilePic = mysqli_query($conn,"select * from ".$masterUserDetailsTbl." where user_id='".$_SESSION[$counterSessionName]['user_id']."'");
									$rowUserProfilePic = mysqli_fetch_array($selectUserProfilePic);
									
									if($rowUserProfilePic['image_file']=="NA")
									{
								?>
								...
								<?php 
									...
									{
								?>
								<span><img class="round" src="userImage/<?php echo $rowUserProfilePic['image_file'];?>" alt="avatar" height="40" width="40"></span>
								<?php
									}
								?>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
								<a class="dropdown-item" href="updateProfileDetails"><i class="feather icon-user"></i> Edit Profile</a>
