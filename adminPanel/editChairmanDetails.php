<?php
	...
	if(isset($_SESSION[$counterSessionName]['user_id']) && $_SESSION[$counterSessionName]['user_id']!="")
	{
		if(in_array(40,$userPermissionDetails))
		{
			...
			{
			$selectChairmanDetails = mysqli_query($conn,"select * from ".$chairmanDetailsTbl." where sl_no='".$valueId."'");														
	...
	<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns"> 
							...
							<div class="col-md-12 col-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Edit Chairman Detail</h4>
										
									</div>
									<div class="card-content">
										<div class="card-body">
											<form class="form form-horizontal" id="formId" action="editChairmanBackend" method="POST" enctype="multipart/form-data" >
												<div class="form-body">
													<input type="hidden" value="<?php echo $valueId;?>" id="chairmanIdValue" name="chairmanIdValue" >
													<div class="row">
														<div class="col-sm-8 col-12">
			                                                <div class="text-bold-600 font-medium-1">Type New Chairman Name</div>
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="text" id="chairmanDetails" name="chairmanDetails" placeholder="Chairman Name" class="form-control" value="<?php echo $rowChairman['chairman_name'];?>" onchange="spclCharChk('chairmanDetails');">
			                                            ...
			                                            <div class="col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <img src="../assets/images/chairman/<?php echo $rowChairman['file_name'];?>" alt="Chairman Image" width="200" height="200">
			                                                </fieldset>
			                                            </div>			                                            
		                                            </div>
		                                            <div class="row">			                                            			                                            
			                                            <div class="col-12">
			                                                ...
			                                                <div class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="file" id="imageTitle" name="imageTitle" placeholder="Upload Document" class="form-control" accept=".png, .jpg, .jpeg" required>
																<div class="form-control-position">
		...
		<script>
			...
			function submitDetails()
			{
				...
				chairmanIdValue=document.getElementById("chairmanIdValue").value;
				chairmanDetails=document.getElementById("chairmanDetails").value;				
