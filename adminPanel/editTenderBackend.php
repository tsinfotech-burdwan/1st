...
<html class="loading" lang="en" data-textdirection="ltr">
	<head>
		...
		<title>Edit Tender Details | <?php echo $rowOrganizationDetails['organization_name'];?></title>
	                        ...
	                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
	                            <div class="card-content">
                        			...
                        			<?php
                                    	...
                                    	else if($errorStatus==6 || $errorStatus==7 || $errorStatus==8 || $errorStatus==9 || $errorStatus==10 || $errorStatus==11 || $errorStatus==12 || $errorStatus==13 || $errorStatus==15)
                                    	{
                        			?>
                                    ...
                                    ?>
	                                    <p class="p-3"></p>
	                                    <a class="btn btn-primary btn-lg" href="listTender">Back to List Tender</a>
	                                </div>
	                            </div>
	                        </div>
	                    </div> 
...
<?php  				
			...
			{
				echo "<script>alert('File Missing...!!! Please Select the File Before Submit...!!!');location.href='listTender';</script>";
			}
		}
		else
		{
