<?php
	...
	{
		if(in_array(66,$userPermissionDetails))
		{
			$mainPageName = "Add Telephone Directory";
			$subPageName = "Add Telephone Directory";
?> 
<!DOCTYPE html>
							...
							<div class="col-md-12 col-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Add Telephone Directory Detail</h4>
									...
									<div class="card-content">
										<div class="card-body">
											<form class="form form-horizontal" id="formId" action="addTelephoneDirectoryBackEnd" method="POST" enctype="multipart/form-data" >
												<div class="form-body">
													<div class="row">																		                                       
			                                            <div class="col-sm-6 col-12">
			                                                <div class="text-bold-600 font-medium-1">Employee Or Departmant Name</div>
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="text" id="employeeOrDepartment" name="employeeOrDepartment" placeholder="Tender Title" class="form-control" onchange="spclCharChk('employeeOrDepartment');">
			                                            ...
			                                            <div class="col-sm-6 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="number" id="extension" name="extension" placeholder="Type Details" class="form-control" onchange="spclCharChk('extension');">
			                                                    <div class="form-control-position">
			                                                       <i class="fa fa-pencil-square-o"></i>
			                                                    </div>
			                                                </fieldset>
				...
				if(employeeOrDepartment=="")
				{
					$(function() {						
						Swal.fire({
							type: 'error',
							title: '  Error !!!',
							text: '  Please Provide Employee Or Department Name!!!',
							timer: 3000
					  	});
					});
