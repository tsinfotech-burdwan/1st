	...
	<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns"> 
							...
							<div class="col-md-12 col-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Edit Calendar Detail</h4>										
									</div>
									<div class="card-content">
										<div class="card-body">
											<form class="form form-horizontal" id="formId" action="editCalendarBackEnd" method="POST" enctype="multipart/form-data" >
												<div class="form-body">
													<input type="hidden" value="<?php echo $valueId;?>" id="calendarIdValue" name="calendarIdValue" >
													<div class="row">
														<div class="col-12">
			                                                <div class="text-bold-600 font-medium-1">Type New Calendar Details</div>
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="text" id="calendarDetails" name="calendarDetails" placeholder="calendar Details" class="form-control" value="<?php echo $rowCalendar['calendar_details'];?>" onchange="spclCharChk('calendarDetails');">
		                                            ...
		                                            <div class="row">
		                                            	<div class="col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <img src="../assets/images/calendar/<?php echo $rowCalendar['calender_image'];?>" alt="Calender Image" width="200" height="200">
			                                                </fieldset>
			                                            </div>
		                                            </div>
		                                            <div class="row">			                                            			                                            
		...
		<script>
			...
			function submitDetails()
			{
				...
				calendarIdValue=document.getElementById("calendarIdValue").value;
				calendarDetails=document.getElementById("calendarDetails").value;				
				...
				if(calendarDetails=="")
				{
					$(function() {						
						Swal.fire({
							type: 'error',
							title: '  Error !!!',
							text: '  Please Provide Calendar Details!!!',
							timer: 3000
					  	});
					});
