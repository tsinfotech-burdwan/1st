<?php
	...
	if(isset($_SESSION[$counterSessionName]['user_id']) && $_SESSION[$counterSessionName]['user_id']!="")
	{
		if(in_array(27,$userPermissionDetails))
		{
			...
			{					
			$selectBannerDetails = mysqli_query($conn,"select * from ".$bannerDetailsTbl." where sl_no='".$valueId."'");
	...
	<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns"> 
							...
							<div class="col-md-12 col-12">
								<div class="card">
									...
									<div class="card-content">
										<div class="card-body"> 
											<form class="form form-horizontal" id="formId" action="backendFilesFolders/editBannerBackend" method="POST" enctype="multipart/form-data" >
												<div class="form-body">
													<input type="hidden" value="<?php echo $_GET['valueId'];?>" id="bannerIdvalue" name="bannerIdvalue" >
													<div class="row">
			                                            <div class="col-sm-4 col-12">
			                                                <div class="text-bold-600 font-medium-1">Banner Title</div>
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="text" id="bannerTitle" name="bannerTitle" placeholder="Banner Title" class="form-control" value="<?php echo $rowBannerDetails['head_title'];?>" onchange="spclCharChk('bannerId');">
			                                            ...
			                                            <div class="col-sm-8 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input id="bannerDetails" name="bannerDetails" placeholder="Banner Details" class="form-control" value="<?php echo $rowBannerDetails['head_details'];?>" onchange="spclCharChk('bannerDetails');"></<input>
			                                                    <div class="form-control-position">
			                                                        <i class="fa fa-pencil-square-o"></i>
			                                                    </div>
			                                                </fieldset>
		                                            ...
		                                            <div class="row">
			                                            ...
			                                            <div class="col-4">
			                                                ...
			                                                <div class="form-group position-relative has-icon-left input-divider-left">
		                                                	<?php
		                                                		if($rowBannerDetails['file_name']!="")
		                                                		{
		                                                	?>
			                                                    <img id="blah" src="../assets/images/banner/<?php echo $rowBannerDetails['file_name'];?>" style="height:569px;width:584px;" alt="your image" />
		                                                    <?php 
		                                                    	}
		                                                    	else
		                                                    	{
		...
		<script>
			...
			function submitDetails()
			{
				...
				bannerIdvalue=document.getElementById("bannerIdvalue").value;
				bannerTitle=document.getElementById("bannerTitle").value;				
				bannerDetails=document.getElementById("bannerDetails").value;				
				...
				if(bannerTitle=="")
				{
					$(function() {						
						Swal.fire({
							type: 'error',
							title: '  Error !!!',
							text: '  Please Provide Banner Title!!!',
							timer: 3000
					  	});
					});
				...
				else if(bannerDetails=="")
				{
					$(function() {						
						Swal.fire({
							type: 'error',
							title: '  Error !!!',
							text: '  Please Provide Banner Details!!!',
							timer: 3000
					  	});
					});
					document.getElementById("submitButton").style.display = "block";
