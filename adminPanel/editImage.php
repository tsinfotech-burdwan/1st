<?php
	...
	{
		if(in_array(37,$userPermissionDetails))
		{
			...
			$selectImageDetails = mysqli_query($conn,"select * from ".$masterImageDetailsTbl." where image_id='".$valueId."'");
							...
							<div class="col-md-12 col-12">
								<div class="card"> 
									<div class="card-header">
										<h4 class="card-title">Edit Image Detail</h4>
									...
									<div class="card-content">
										<div class="card-body">
											<form class="form form-horizontal" id="formId" action="backendFilesFolders/editImageBackEnd" method="POST" enctype="multipart/form-data" >
												<div class="form-body">
													<input type="hidden" value="<?php echo $_GET['valueId'];?>" id="imageIdvalue" name="imageIdvalue" >
													<div class="row">
			                                            <div class="col-sm-12 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
																...
																<?php 
																	...
																	{
																?>
																	<option value="<?php echo $rowFolderDetails['folder_id'];?>" <?php if($rowImageDetails['folder_id']==$rowFolderDetails['folder_id']){echo "selected";}?>><?php echo $rowFolderDetails['folder_name'];?></option>
																<?php
																	}
																?>
																</select>
			                                            ...
			                                            <div class="col-sm-12 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="text" id="noticeTitle" name="noticeTitle" placeholder="Image Title" class="form-control" onchange="spclCharChk('noticeTitle');" value="<?php echo $rowImageDetails['image_title'];?>">
			                                                    <div class="form-control-position">
			                                                       <i class="fa fa-pencil-square-o"></i>
			                                                    </div>
			                                                </fieldset>
		                                            ...
		                                            <div class="row">
			                                            ...
			                                            <div class="col-4">
			                                                ...
			                                                <div class="form-group position-relative has-icon-left input-divider-left">
			                                                <?php
		                                                		if($rowImageDetails['image_file']!="")
		                                                		{
		                                                	?>
			                                                    <img id="blah" src="../gallery/<?php echo $rowImageDetails['image_file'];?>" style="height:569px;width:584px;" alt="your image" />
		                                                    <?php 
		                                                    	}
		                                                    	else
		                                                    	{
