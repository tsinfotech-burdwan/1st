<?php
	...
	if(isset($_SESSION[$counterSessionName]['user_id']) && $_SESSION[$counterSessionName]['user_id']!="")
	{
		...
		{
			$mainPageName = "Add Tender";
			$subPageName = "Add Tender";
?>
<!DOCTYPE html>
							...
							<div class="col-md-12 col-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Add Tender Detail</h4>
									</div>
									<div class="card-content">
										<div class="card-body">
											<form class="form form-horizontal" id="formId" action="addTenderBackend" method="POST" enctype="multipart/form-data" >
												<div class="form-body">
													<div class="row">
			                                            <div class="col-sm-4 col-12">
			                                                <div class="text-bold-600 font-medium-1">Tender ID/Reference No</div>
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="text" id="tenderId" name="tenderId" placeholder="Tender ID" class="form-control" onchange="spclCharChk('tenderId');">
			                                            ...
			                                            <div class="col-sm-4 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <textarea id="TenderDetails" name="TenderDetails" placeholder="Tender Details" class="form-control" onchange="spclCharChk('TenderDetails');"></textarea>
			                                                    <div class="form-control-position">
			                                                        <i class="fa fa-pencil-square-o"></i>
			                                                    </div>
			                                                </fieldset>
			                                            ...
			                                            <div class="col-sm-4 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="number" id="receiveAmount" name="receiveAmount" placeholder="Amount" class="form-control" onchange="spclCharChk('receiveAmount');">
			                                                    <div class="form-control-position">
			                                                        <i class="fa fa-inr"></i>
			                                                    </div>
			                                                </fieldset>
													...
													<div class="row">
														<div class="col-sm-4 col-12">
				                                            <div class="text-bold-600 font-medium-1">Bid Start Date</div>
				                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
				                                                    <input type="date" id="bidStartDate" name="bidStartDate" placeholder="Start Date" class="form-control" onchange="spclCharChk('bidStartDate');" min="<?php echo date('Y-m-d');?>">
				                                                    <div class="form-control-position">
				                                            ...
				                                            <div class="col-sm-4 col-12">
				                                                ...
				                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
				                                                    <input type="date" id="bidEndDate" name="bidEndDate" placeholder="Bid End Date" class="form-control" onchange="spclCharChk('bidEndDate');" min="<?php echo date('Y-m-d');?>">
				                                                    <div class="form-control-position">
														...
														<div class="col-sm-4 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="date" id="bidOpenDate" name="bidOpenDate" placeholder="Bid Open Date" class="form-control" onchange="spclCharChk('bidOpenDate');" min="<?php echo date('Y-m-d');?>">
			                                                    <div class="form-control-position">
			                                                        <i class="fa fa-calendar"></i>
			                                                    </div>
			                                                </fieldset>
