							...
							<div class="col-md-12 col-12">
								<div class="card">
									...
									<div class="card-content">
										<div class="card-body">
											<form class="form form-horizontal" id="formId" action="backendFilesFolders/editChairmanInCouncilBackEnd" method="POST" enctype="multipart/form-data" >
												<div class="form-body">
													...
													<div class="row">
			                                            ...
			                                            <div class="col-sm-8 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="text" id="name" name="name" placeholder="Name" class="form-control" value="<?php echo $rowChairmanInCouncil['name'];?>" onchange="spclCharChk('name');">
			                                                    <div class="form-control-position">
			                                            ...
			                                            <div class="col-sm-4 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="number" id="wardNo" name="wardNo" placeholder="Ward No" class="form-control" value="<?php echo $rowChairmanInCouncil['ward_no'];?>" onchange="spclCharChk('wardNo');">
			                                                    <div class="form-control-position">
			                                                       <i class="fa fa-pencil-square-o"></i>
			                                                    </div>
			                                                </fieldset>
			                                            ...
			                                            <div class="col-sm-8 col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="number" id="mobileNo" name="mobileNo" placeholder="Mobile No" class="form-control" value="<?php echo $rowChairmanInCouncil['mobile_no'];?>" onchange="spclCharChk('mobileNo');">
			                                                    <div class="form-control-position">
			                                                       <i class="fa fa-pencil-square-o"></i>
			                                                    </div>
			                                                </fieldset>
