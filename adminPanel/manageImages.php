<?php
	...
	{
		if(in_array(35,$userPermissionDetails) || in_array(36,$userPermissionDetails) || in_array(37,$userPermissionDetails) || in_array(38,$userPermissionDetails))
		{
												...
												<table class="table table-bordered zero-configuration">
													<thead>
														<tr>
															...
															<th>Name</th>
														<?php 
															if(in_array(36,$userPermissionDetails) || in_array(37,$userPermissionDetails))
															{
														?>
															<th>Action</th>
														<?php
