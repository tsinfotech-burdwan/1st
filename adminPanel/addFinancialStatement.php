<?php
	...
	if(isset($_SESSION[$counterSessionName]['user_id']) && $_SESSION[$counterSessionName]['user_id']!="")
	{
		if(in_array(42,$userPermissionDetails))
		{
			...
			$subPageName = "Add Financial Statement";
?> 
<!DOCTYPE html>
	...
	<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns"> 
							...
							<div class="col-md-12 col-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Add Financial Statement Detail</h4>
									...
									<div class="card-content">
										<div class="card-body">
											<form class="form form-horizontal" id="formId" action="backendFilesFolders/addFinancialStatementBackEnd" method="POST" enctype="multipart/form-data" >
												<div class="form-body">
													<div class="row">
														<div class="col-sm-8 col-12">
			                                             	<div class="text-bold-600 font-medium-1">Statement Type</div>
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <select id="financialStatementType" name="financialStatementType" class="form-control select2" onchange="spclCharChk('financialStatementType');">
																	<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select Notice Type</option>
																	<option value="Audit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Audit</option>										
																	<option value="Balance Sheet">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Balance Sheet</option>										
																	<option value="Budget Estimate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Budget Estimate</option>										
																	<option value="Demand And Collection">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demand And Collection</option>										
																	<option value="Payment Receipt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Payment Receipt</option>										
																	<option value="Income Expenditure">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Income Expenditure</option>										
																	<option value="Unaudited AFS">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Unaudited AFS</option>										
																</select>
			                                            ...
			                                            <div class="col-12">
			                                                ...
			                                                <fieldset class="form-group position-relative has-icon-left input-divider-left">
			                                                    <input type="text" id="financialStatementDetails" name="financialStatementDetails" placeholder="Tender Title" class="form-control" onchange="spclCharChk('financialStatementDetails');">
			                                                    <div class="form-control-position">
		...
		<script>
			...
			function submitDetails()
			{
				...
				financialStatementType=document.getElementById("financialStatementType").value;
				...
				if(financialStatementType=="")
				{
					$(function() {						
						Swal.fire({
							type: 'error',
							title: '  Error !!!',
							text: '  Please Provide Financial Statement Title!!!',
							timer: 3000
					  	});
					});
