$(window).on("load", function(){
    ...
    var pieChartoption = {
        ...
        legend: {
            orient: 'vertical',
            left: 'left',
            data: ['Total Allocation', 'Pending Lead', 'Process Lead', 'Positive Lead', 'Negative Lead']
        },
        series : [
            {
                name: 'Access source',
                ...
                data: [
                  {value: 335, name: 'Total Allocation'},
                  {value: 310, name: 'Pending Lead'},
                  {value: 234, name: 'Process Lead'},
                  {value: 135, name: 'Positive Lead'},
                  {value: 1548, name: 'Negative Lead'}
                ],
                itemStyle: {
                    emphasis: {
                        shadowBlur: 10,
