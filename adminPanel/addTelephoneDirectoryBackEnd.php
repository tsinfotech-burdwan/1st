	...
	{ 
		if(in_array(66,$userPermissionDetails)) 
		{
			...
			else
			{
				...
				{
					$insert = mysqli_query($conn,"insert into ".$telephoneDirectoryDetailsTbl." set employee_or_depatment_name='".$employeeOrDepartment."',extention='".$extension."',status='0'");
					if($insert) 
					{
						$errorStatus="1";
					}
	                        ...
	                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
	                            <div class="card-content">
                                   ...
                                   <?php 
                                    ...
                                    ?>
	                                    <p class="p-3"></p>
	                                    <a class="btn btn-primary btn-lg" href="addTelephoneDirectory">Back to add Telephone Directory</a>
	                                </div>
	                            </div>
	                        </div>
	                    </div> 
