...
<head>
    ...
    <title>Balance Sheet Statements</title>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-5">
                        <h1 class="display-6 large ff-heading text-white position-relative ps-4">
                            ...
                            <span>Balance Sheet Statements</span>
                        </h1>
                    </div>
                    <div class="col-lg-7">
                ...
                <div class="overflow-auto">
                    <table class="table table-striped border" style="min-width: 800px;">
                        ...
                        <tbody>
                            <?php
                                $counter=1;
                                $selectFinancialStatement = mysqli_query($conn,"select * from ".$financialStatementDetailsTbl." where title='Balance Sheet' and status='1' order by financial_year desc");
