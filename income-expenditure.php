...
<head>
    ...
    <title>Income Expenditure Financial Statements</title>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-5">
                        <h1 class="display-6 large ff-heading text-white position-relative ps-4">
                            ...
                            <span>Income Expenditure Financial Statements</span>
                        </h1>
                    </div>
                    <div class="col-lg-7">
                        <div class="position-relative">
                            ...
                            <img src="assets/images/common/History-of-Burdwan-Municipality.jpg" width="746" height="250"
                                alt="Income Expenditure Financial Statements"
                ...
                <div class="overflow-auto">
                    <table class="table table-striped border" style="min-width: 800px;">
                        ...
                        <tbody>
                            <?php
                                $counter=1;
                                $selectFinancialStatement = mysqli_query($conn,"select * from ".$financialStatementDetailsTbl." where title='Income Expenditure' and status='1' order by financial_year desc");
